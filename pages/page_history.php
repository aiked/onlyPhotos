...
<?php
	$q = "SELECT DISTINCT  t.*, ct.photo_quan,ct.photo_amount,ct.photo_id FROM transactions t , complete_transactions ct WHERE  t.id = ct.trans_id ";
	$q_cmp="";
...
<html>
    ...
    <body onLoad="init()">
		<div id="container">
			...
			<div id="context">
			<form action="../pages/page_history.php" method="post">
				<table align="center">
			  ...
			  <?php  
					...
					if (($res = mysql_query($q)))
					{
						...
						while($r = mysql_fetch_array($res))
						{
							...
							$total+=$r['photo_amount'];
							$total_quan+= $r['photo_quan'];	
			  ...
			  ?>
			  <tr><td colspan="4" style="text-align:right;">total<td class='history'> <?php echo $total_quan; ?></td> <td class='history'> <?php echo $total; ?>&#8364</td> </tr>
			  </table>
			</div>
